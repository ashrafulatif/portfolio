        ...
        {!showAll && data.projects.length > 3 && (
          <div className="mt-24 text-center">
            <button 
              ...
              className="group relative px-12 py-4 overflow-hidden rounded-full border border-navy/10 text-navy text-[10px] font-bold uppercase tracking-[0.2em] hover:text-white hover:border-navy transition-all duration-500 active:scale-95"
            >
